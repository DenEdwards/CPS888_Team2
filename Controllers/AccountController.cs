...
namespace Cafeteria.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(User user)
        {
            ...
            {
                User c = db.Users.Where(u => u.Email == user.Email).FirstOrDefault();
                if (c != null)
                {
        ...
        // GET: /Account/Register
        [AllowAnonymous]
        public ActionResult CatererRegister()
        {
            return View();
        }
        ...
        // GET: /Account/Login
        [AllowAnonymous]
        public ActionResult CatererLogin(string returnUrl)
        {
            ViewBag.ReturnUrl = returnUrl;
            return View();
        }
        ...
        public ActionResult LogOff()
        {
            ...
            else if ((Session["CatererEmail"] != null) && (Session["CatererId"] != null))
            {
                Session["CatererEmail"] = null;
                Session["CatererId"] = null;
                ViewBag.CatererId = "-1";
        ...
        [HttpGet]
        [AllowAnonymous]
        public ActionResult CatererLogOff()
        {
            Session["CatererEmail"] = null;
            Session["CatererId"] = null;
            ViewBag.CatererId = "-1";
